...
Y.extend(Editor, Y.Base, {
    ...
    publishEvents: function() {
        ...
        /**
         * Fired when getCleanHTML routine is called in clean.js
         *
         * @event atto:htmlcleaned
         */
        this.publish('atto:htmlcleaned', {
            prefix: 'atto'
        });

        /**
         * Fired when atto cleans styles during pasting.
         *
         * @event atto:pastehtmlstylescleaned
         */
        this.publish('atto:pastehtmlstylescleaned', {
            prefix: 'atto'
        });

        /**
         * Fired when atto cleans class during pasting.
         *
         * @event atto:pastehtmlclasscleaned
         */
        this.publish('atto:pastehtmlclasscleaned', {
            prefix: 'atto'
        });
...
EditorClean.prototype = {
    ...
    getCleanHTML: function() {
        ...
        var htmlWrapper = {args: {html: html}};
        this.fire('atto:htmlcleaned', htmlWrapper);

        return htmlWrapper.args.html;
    },
    ...
    _cleanHTML: function(content) {
        ...
        var htmlWrapper = {args: {html: content}};
        this.fire('atto:htmlcleaned', htmlWrapper);
    ...
    _cleanStyles: function(content) {
        ...
        elementsWithStyle = Array.prototype.slice.call(elementsWithStyle);
        this.fire('atto:pastehtmlstylescleaned', {args: elementsWithStyle});
        var i = 0;
        ...
        elementsWithClass = Array.prototype.slice.call(elementsWithClass);
        this.fire('atto:pastehtmlclasscleaned', {args: elementsWithClass});
