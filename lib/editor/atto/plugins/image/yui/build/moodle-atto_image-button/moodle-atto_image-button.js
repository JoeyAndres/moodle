...
Y.M.atto_image.rotateHandleTemplate =
    '<div class="atto-image-rotate-handle-container atto_control">' +
...
Y.extend(Y.M.atto_image.EditableImg, Y.Base, {
    ...
    initializer: function(cfg) {
        ...
        if (!this.nodeWrapper) {
            ...
            this.nodeWrapper = this.nodeInnerWrapper.ancestor('.atto-image-inner-wrapper');
        }
...
Y.namespace('M.atto_image').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _destroyRotatable: function() {
        if (this._rotatable) {
            this._rotatable.disable();
