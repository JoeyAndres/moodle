...
Y.M.atto_image.imgWrapperTemplate =
    '<div class="atto-image-wrapper" contenteditable="false">' +
...
Y.M.atto_image.rotateHandleTemplate =
    '<div class="atto-image-rotate-handle-container">' +
...
Y.namespace('M.atto_image').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    initializer: function() {
        ...
        host.on('atto:pastehtmlclasscleaned', this._exemptAttoImageWrapperFromClassRemoval, this);
    },
