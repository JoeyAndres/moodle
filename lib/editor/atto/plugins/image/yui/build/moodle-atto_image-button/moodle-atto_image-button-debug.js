...
Y.extend(Y.M.atto_image.DeleteMutationObserver, Y.Base, {
    ...
    isSupported: function() {
        ...
        Y.log(supported ? 'supported' : 'not supported', 'debug', 'atto_image:delete-mutation-observer');
        return supported;
    }
});// This file is part of Moodle - http://moodle.org/
//
...
Y.extend(Y.namespace('M.atto_image').resizable, Y.Base, {
    ...
    _createGhostNodeContainer: function() {
        ...
        ghostNodeContainer.before('dragstart', function(e) {
            Y.log('dragstart', 'debug', 'atto_image:resizable');
            e.halt(true);
        }, this);
    ...
    isSupported: function() {
        ...
        Y.log(supported ? 'supported' : 'not supported', 'debug', 'atto_image:resizable');
        return supported;
    }
});// This file is part of Moodle - http://moodle.org/
//
