...
Y.extend(Y.M.atto_image.EditableImgGhostContainer, Y.Base, {
    ...
    /**
     * Decoupled from this.enable since this thing will throw an error until attached to DOM.
     */
    ...
    /**
     * Size of the node (img).
     * @return {width: {Number}, height: {Number}}
     */
    getNodeSize: function() {
        var newWidth =
            Y.M.atto_image.utility.parseInt10(this.node.getComputedStyle("width")) -
            Y.M.atto_image.utility.getHorizontalNonContentWidth(this.node);
        var newHeight =
            Y.M.atto_image.utility.parseInt10(this.node.getComputedStyle("height")) -
            Y.M.atto_image.utility.getVerticalNonContentWidth(this.node);
    ...
    _createGhostNodeContainer: function() {
        ...
        ghostNodeContainer.setStyles(this.getNodeSize());
...
Y.extend(Y.namespace('M.atto_image').resizable, Y.Base, {
    ...
    enable: function() {
        ...
        this.node.insert(this._editableImgGhostContainer.getGhostNodeContainer(), "before");
        this._editableImgGhostContainer.getGhostNodeContainer().appendChild(this._resizableOverlayNode);
    ...
    _onResizeStart: function(e) {
        ...
        this._editableImgGhostContainer.getGhostNodeContainer().setStyles(this.getNodeSize());
    ...
    _onResizeEnd: function(e) {
        ...
        // Since we were resizing the hidden this.node, we can use that as our dimension.
        this._editableImgGhostContainer.getGhostNodeContainer().setStyles(this.getNodeSize());  // todo: make a method.
