...
Y.namespace('M.atto_image').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _destroyEditableImg: function() {
        Y.log("destroy", 'debug', 'atto_image');
        if (this._editableImg) {
            ...
            if (alignPlugin && alignPlugin.isEnabled()) {
                alignPlugin.buttons.justifyLeft.detach('click', this._editableImg.alignLeft, this._editableImg);
                alignPlugin.buttons.justifyCenter.detach('click', this._editableImg.alignNone, this._editableImg);
                alignPlugin.buttons.justifyRight.detach('click', this._editableImg.alignRight, this._editableImg);
            }
    ...
    _editableImgInitHandler: function(e) {
        ...
        if (alignPlugin && alignPlugin.isEnabled()) {
            Y.log('atto_image enabled', 'debug', 'atto_image');
            alignPlugin.buttons.justifyLeft.on('click', editableImg.alignLeft, editableImg);
            alignPlugin.buttons.justifyCenter.on('click', editableImg.alignNone, editableImg);
            alignPlugin.buttons.justifyRight.on('click', editableImg.alignRight, editableImg);
        }
