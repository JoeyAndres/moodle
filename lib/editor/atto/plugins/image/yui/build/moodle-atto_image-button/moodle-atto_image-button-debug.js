...
Y.namespace('M.atto_image').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    initializer: function() {
        ...
        host.on('atto:htmlcleaned', function(e) {
            ...
            content = this._cleanHelperClasses(content);
            content = this._removeAttoControlDuringCopyAndPaste(content);
            content = this._removeUnwantedCleanUpElements(content);
            content = this._disableAttoImageWrapperContentEditable(content);
            e.args.html = content;
        }, this);
